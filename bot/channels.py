...
@listen_to(r'(?:\W|^)(suck[s]{0,1}|bastard[s]{0,1}|puss[yies]{1,3}|dick[s]{0,1}|ass[es]{0,2}|shut up|fuck[a-z]{0,3}|bi[a]{0,1}tch[a-z]{0,2}|shit|cul[s]{0,1}|bite[s]{0,1}|anus|con[s]{0,1}|conne[s]{0,1}|connard[s]{0,1}|connasse[s]{0,1}|bolosse[s]{0,1}|salaud[s]{0,1}|salope[s]{0,1}|encul[a-zé]{1,3}|niqu[éerzs]{1,3}|bais[a-zé]{1,3}|chi[eérs]{1,3}|chiant[s]{0,1}|pute[s]{0,1}|batard[a-z]{0,2}|gueule[s]{0,1}|pd|tg|ftg|fdp|ptn|ntm|putain[s]{0,1}|couille[s]{0,1}|merd[a-zé]{1,2}|ta m[eè]{1}re|vos m[eè]{1}res)(?:\W|$)', re.IGNORECASE)
...
@listen_to(r'(?:\W|^)(man down|[i]{0,1}s hit|[i]{0,1}s down|[i]{0,1}s dead|est mort|est décédé|homme à terre|est à terre)(?:\W|$)', re.IGNORECASE)
